...
const coverageGate = S.Coverage.Gate({
	report: testCoverage,
	thresholds: { lines: 96, functions: 100, branches: 95.23, statements: 96 },
})
...
// @tevm/sync-storage-persister declarations from the registry, surface is
// this tree's emit.
...
// `smthrs //packages/sync-storage-persister:check`.
const check = S.Suite({
