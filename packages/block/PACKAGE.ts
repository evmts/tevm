...
const Shell = scopedShell('packages/block')
...
// vitest.config.ts declares all four thresholds as 0, so the gate passes any
// run. Declared verbatim so the graph shows the ratchet is off.
