...
const Shell = scopedShell('packages/contract')
...
// tsconfig outDir. Vitest reads vitest.config.ts; the sibling vite.config.ts
// is unreferenced legacy and is not key material for any target.
