...
// test:run. No spec file needs a live RPC; the WebSocket suite does bind a
// real 127.0.0.1 listener, so loopback is allowed while egress stays denied.
...
// Semver as a gate: baseline is the last published @tevm/server
