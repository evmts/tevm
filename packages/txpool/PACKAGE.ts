...
const Shell = scopedShell('packages/txpool')
...
// test:coverage. vitest.config.ts declares no thresholds, so there is no
// coverageGate for this package.
...
// @tevm/txpool declarations from the registry, surface is
// this tree's emit.
