...
// targets and nothing else. src/fixtures/** stays in srcs: the resolution
// specs read those Solidity trees.
...
const coverageGate = S.Coverage.Gate({
	report: testCoverage,
	thresholds: { lines: 99.28, functions: 100, branches: 97.87, statements: 99.31 },
})
...
// Semver gate against the last published @tevm/resolutions declarations.
