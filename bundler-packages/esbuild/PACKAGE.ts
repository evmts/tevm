...
const Shell = scopedShell('bundler-packages/esbuild')
...
// tsconfig outDir (types/). Skipped scripts: `build` is the nx run-many
...
// Semver gate against the last published @tevm/esbuild-plugin declarations.
